...
public class GymChainInfo {
    ...
    public static final String PAVNEET_GYM_NAME= "My Gym";
    public static final String PAVNEET_MEMBER_NAME = "Pavneet";
    ...
    private static void loadMembers(GymChain chain){
        ...
        chain.signUpMember(m3);
         ...
         Member m4 = new Member(PAVNEET_MEMBER_NAME);
    ...
    private static void loadGyms(GymChain chain){
        ...
        Gym g4 = new Gym(PAVNEET_GYM_NAME);
        initializeGym0(g4);
        chain.addGym(g4);
    }
