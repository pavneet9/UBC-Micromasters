...
public class InfoManager {
    ...
    private void printInstructions(){
        ...
        System.out.println("Enter '" + PAVNEET_GYM_NAME + "' for Fitlife " + YOUR_GYM_NAME);
    ...
    private void registerMemberForClass(Member m, FitnessClass fc){
        ...
        if(eligible){
            fc.registerMember(Member m);
            printRegisteredMembers(FitnessClass fc);
        }
        else{
        ...
        if (str.length() > 0) {
            switch (str) {
                ...
                case PALM_LAKE_COMMAND:
                    ...
                    break;
                case PAVNEET_GYM_NAME:
                    printGymInfo(chain.lookupGymByName(PAVNEET_GYM_NAME));
                    break;
